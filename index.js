...
const instagram = 'https://www.instagram.com/the_rifan/'; 
const telegram = 'https://web.telegram.org/#/im'; 
const kapanbotaktif = 'Jam 10:00-17:10'; 
const youtube = 'https://youtube.com/channel/UC2hXQKxYxOI16maXAHt39Hg';
const grupch1 = 'https://chat.whatsapp.com/HXenxIUIjFQKLNVOFC8fM4'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@The_Rifan')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@The_Rifan`)
})
